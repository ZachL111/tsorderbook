"""Regression checks for the tsorderbook casebook."""
...
from casebook.harness import assert_expected, tsorderbook_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tsorderbook_summary(), assert_expected())
