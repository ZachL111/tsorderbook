...
tsorderbook is a TypeScript project for trading systems. It focuses on this technical goal: Maintain price-time priority order books from event logs.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 152, risk penalty 6, latency penalty 3, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
